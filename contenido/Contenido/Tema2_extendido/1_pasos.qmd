...
---
# Iniciar un repossitorio con github y nbdev. 
...
Los repositorios nos permiten mantener un orden en el código y un control de cambios, por la simpleza usaremos [Github](https://github.com) donde alojaremos el repositorio de nuestro desarrollo. Para poder crear un repositorio dentro de github sera necesario crear una cuenta dentro del sitio. 
...
Este comando debera ejecutarse dentro del directorio del repositorio. El comando generará tres subdirectorios:
...
Si vamos a nuestro repositorio dentro de Github podemos observar que ya tenemos los archivos y los subdirectorios en Github igual que lo tenemos dentro de nuestros archivos locales. 
