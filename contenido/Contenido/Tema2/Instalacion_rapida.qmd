...
2. Verificar que se ha bajado correctamente ([ver](https://docs.conda.io/projects/conda/en/latest/user-guide/install/download.html#hash-verification) ).
...
Dentro de la terminal se puede observar que antes del símbolo del sistema aparece la leyenda `(base)` esta nos indica que estamos usando el ambiente virtual base. 
...
Markdown nos permite mantener un orden dentro del documento haciendo uso de `#`, este funciona para indicar un encabezado e inicio de la sección. Markdown nos permite hacer subsecciones a partir del uso consecutivo de `#`. 
