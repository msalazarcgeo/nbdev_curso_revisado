...
![Inicio de JupyterLab \label{mylabel}](./Inicio_jupyter.png){#fig:inicioJL}

Una vez ejecutado el comando se desplegara un servicio web el cual se puede acceder desde un navegador y nos mostrara una pagina web muy similar a la que se muestra en \ref{mylabel}. 




Para empezar un nuevo notebook se elige la version de python que se desea que se ejecute y esta generara un nuevo notebook con nombre 'Untitled.ipynb'
