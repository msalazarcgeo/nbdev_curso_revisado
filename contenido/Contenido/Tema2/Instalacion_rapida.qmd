...
En los notebooks se tienen tres tipos de celda ('Code', 'Markdown' y 'Raw') las cuales se usan con distintos propositos. 'Code' se utiliza para la ejecución de código, la celdas 'Markdown' nos permite hacer uso de el lenguaje Markdown para el enriquecimiente del texto plano y 'Raw' simplemente va a mostrar el contenido dentro de la celda. Como ejemplo este curso hace uso de los Notebooks y Markdown.   
